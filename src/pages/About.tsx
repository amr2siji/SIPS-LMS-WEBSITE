...
export function About() {
  ...
  const teamMembers = [
    ...
    {
      name: "Madara Weerasinghe",
      title: "Consultant Academic Administration",
      qualifications: "PGDip Chemistry Education (UOC), BSc (Hons) in Chemistry",
      bio: "Madara Weerasinghe is an accomplished academic administrator and a Chemistry educator with extensive expertise in educational leadership, strategic planning, and organizational development. With over 10 years of experience in higher education she has demonstrated exceptional capability in managing complex academic operations, student affairs, and institutional quality assurance. Holding a PGDip in Chemistry Education  from the University of Colombo and a Bachelor's degree in Chemistry, Madara strengthens her understanding of pedagogical frameworks and curriculum development. As Director of Academic Administration, she oversees critical functions including academic planning, student registration systems, examination coordination, and compliance with regulatory standards. Her commitment to excellence and continuous improvement makes her an invaluable asset to the institution's leadership team.",
      imageBase: "/team/Madara Weerasinghe"
    },
    /*
    {
      name: "Charunadi Ratnayake",
      title: "Consultant Academic Affairs",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO 
        title="About SIPS - Our Team & Vision | Steller Institute of Professional Studies"
        description="Learn about SIPS (Steller Institute of Professional Studies) - a leading educational institution in Galle, Sri Lanka. Meet our expert team of educators, consultants, and administrators committed to transforming education through quality programmes, industry partnerships with IBM, and academic excellence."
        keywords="about SIPS, SIPS team, SIPS Sri Lanka, education leadership Sri Lanka, academic excellence, Pabasara Amarawardena, Madara Weerasinghe, Charunadi Ratnayake, Dr. Dimuthu Senevirathne, educational institution Galle, quality education Sri Lanka"
        canonical="https://www.sips.edu.lk/about"
      />
      {/* Hero Section */}
      <section
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gray-100">
        <div className="text-center mb-16 animate-fade-in-up">
          <div className="bg-amber-100 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6">
            <Users className="text-amber-700" size={48} />
          </div>
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Meet Our Consultants</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Expert advisors providing strategic guidance and specialized expertise.
          </p>
        </div>
        ...
        <div className="space-y-12">
          {consultants.map((member, index) => (
            ...
            >
              ...
              <div className="md:w-2/3 p-8 md:p-10">
                <h3 className="text-3xl font-bold text-gray-900 mb-2">{member.name}</h3>
                <p className="text-xl text-amber-700 font-semibold mb-3">{member.title}</p>
                <p className="text-sm text-gray-600 font-medium mb-4 italic">{member.qualifications}</p>
      ...
      {/* Call to Action */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-emerald-700 to-emerald-900 rounded-2xl p-12 text-center text-white animate-fade-in-up hover:scale-105 transition-transform duration-300">
